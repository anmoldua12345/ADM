...
public class Fragmenttwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView= (RecyclerView) v.findViewById(R.id.rvactivitymainone);
        new doit().execute();
        return v;
    }
    ...
    public class doit extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                Document doc = Jsoup.connect("https://mr-jatt.com/hindisongs-top20.html").timeout(30000).get();
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            adapter=new RecyclerAdapterone(list3,list2,list4,getActivity());
