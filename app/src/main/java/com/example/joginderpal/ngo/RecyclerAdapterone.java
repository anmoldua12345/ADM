...
public RecyclerAdapterone(List<String> list, List<String> list2, List<String> list4, Context ctx) {
        this.list2=list2;
        this.list=list;
        this.list4=list4;
        this.ctx=ctx;
...
class ViewHolder extends RecyclerView.ViewHolder{
    ...
    public ViewHolder(View itemView) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i=new Intent(ctx,Fragmentonetwo.class);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layoutone,parent,false);
